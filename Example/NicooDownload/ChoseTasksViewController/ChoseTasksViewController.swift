...
class ChoseTasksViewController: UIViewController {
    ...
    lazy var nameString: [String] = {
        let names = ["monkeyKing.mp4","TeacherCang.mp4","来个中文试试.mp4","boduoyejieyi.mp4","201712191351314533.mp4","201801261644030991.mp4","201802021322446621.mp4","201802011038548146.mp4","201802011545189269.mp4","201802021436174669.mp4","201801311435101664.mp4","201801311059389211.mp4","201712190944143459.mp4"]
        return names
    ...
    private lazy var editBarButton: UIBarButtonItem = {
        ...
        barBtn.setTitleTextAttributes([NSAttributedStringKey.font: UIFont.systemFont(ofSize: 16), NSAttributedStringKey.foregroundColor: UIColor.purple], for: .normal)
        return barBtn
    }()
